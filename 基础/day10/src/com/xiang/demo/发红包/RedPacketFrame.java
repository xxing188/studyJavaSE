 ...
 *
 * 页面部分-- 包含三个页面 输入页面-- InputPanel 打开页面-- OpenPanel 展示页面-- ShowPanel
 *
 * @author xiaoliguang
 *
 */
public abstract class RedPacketFrame extends JFrame {
    ...
    private static HashMap<JPanel, JLabel> panel_lable = new HashMap<JPanel, JLabel>();
    // 设置字体
    private static Font font_yahei = new Font("微软雅黑", Font.BOLD, 20);
    private static Font msg_font = new Font("微软雅黑", Font.BOLD, 20);
    private static Font total_show_font = new Font("微软雅黑", Font.BOLD, 40);
    private static Font name_font = new Font("微软雅黑", Font.BOLD, 40);
    private static Font showName_font = new Font("微软雅黑", Font.BOLD, 20);
    private static Font showMoney_font = new Font("微软雅黑", Font.BOLD, 50);
    private static Font showResult_font = new Font("微软雅黑", Font.BOLD, 15);
    ...
    private static JLabel input_bg_label = new JLabel(new ImageIcon("E:\\JavaBase\\day10\\src\\com\\xiang\\demo\\发红包\\pic\\01_input.jpg"));
    static {
        ...
        // 设置字体
        input_total.setFont(font_yahei);
        input_count.setFont(font_yahei);
        input_people.setFont(font_yahei);
        input_msg.setFont(msg_font);
        input_msg.setForeground(new Color(255, 233, 38)); // 字体颜色 为金色
        input_total_show.setFont(total_show_font);
        input_inMoney.setFont(font_yahei);
    ...
    private static JTextField open_ownerName = new JTextField("谁谁谁谁");
    private static JLabel open_label = new JLabel(new ImageIcon("E:\\JavaBase\\day10\\src\\com\\xiang\\demo\\发红包\\pic\\02_open_2.gif"));
    private static JLabel open_bg_label = new JLabel(new ImageIcon("E:\\JavaBase\\day10\\src\\com\\xiang\\demo\\发红包\\pic\\02_open_1.jpg"));
    static {
        ...
        // 设置字体
        open_ownerName.setFont(name_font);
    ...
    private static JLabel show_bg_label = new JLabel(new ImageIcon("E:\\JavaBase\\day10\\src\\com\\xiang\\demo\\发红包\\pic\\03_money_1.jpg"));
    ...
    static {
        ...
        show_name.setFont(showName_font);
        ...
        show_money.setFont(showMoney_font);
        ...
        show_result.setFont(showResult_font);
    ...
    private void initFrame() {
        // logo
        this.setIconImage(Toolkit.getDefaultToolkit().getImage("E:\\JavaBase\\day10\\src\\com\\xiang\\demo\\发红包\\pic\\logo.gif"));
     ...
     *  ownerName : 群主名称
     */
    public String ownerName = "谁谁谁谁"; // 群主名称
    /**
     * openWay : 红包的类型 [普通红包/手气红包]
     */
    public OpenMode openWay = null;
